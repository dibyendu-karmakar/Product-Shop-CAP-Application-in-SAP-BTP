...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("MaterialEntityListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheMaterialEntityListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheMaterialEntityListGenerated.onFilterBar().iChangeSearchField("Search Term");
